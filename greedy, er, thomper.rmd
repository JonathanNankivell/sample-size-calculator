...
sim_data1 <- simulator(numb_of_sims, numb_of_patients, one_run, balanced, NA)
balanced.props1 <- sim_data1[(numb_of_patients+6):(length(sim_data1))]
balanced.results1 <- sim_data1[1:(numb_of_patients+4)]
balanced.ys1 <- balanced.results1[1:(length(balanced.results1)-4)]
balanced.power1 <- balanced.results1[length(balanced.results1)-3]
balanced.ENS1 <- mean(balanced.ys1)
balanced.S101 <- balanced.results1[length(balanced.results1)]
sprintf("power is %f", balanced.power1)

png("C:\\Users\\nanki\\Downloads\\greedy, ER, Thomper.png")
par(mfrow = c(2, 2))
plot(balanced.ys1 ~ x, type='l',xlim=c(0,numb_of_patients),ylim=c(0,1), main="Uniform Priors & 100 Patients", sub=paste(numb_of_patients, "Patients"), xlab="Patient Index", ylab="Probability of Best Treatment", col=colours[1], lwd=width)
...
sim_data2 <- simulator(numb_of_sims, numb_of_patients, one_run, balanced, NA)
balanced.props2 <- sim_data2[(numb_of_patients+6):(length(sim_data2))]
balanced.results2 <- sim_data2[1:(numb_of_patients+4)]
balanced.ys2 <- balanced.results2[1:(length(balanced.results2)-4)]
balanced.power2 <- balanced.results2[length(balanced.results2)-3]
balanced.ENS2 <- mean(balanced.ys2)
balanced.S102 <- balanced.results2[length(balanced.results2)]
sprintf("power is %f", balanced.power2)

plot(balanced.ys2 ~ x, type='l',xlim=c(0,numb_of_patients),ylim=c(0,1), main="Unequal Priors & 100 Patients", sub=paste(numb_of_patients, "Patients"), xlab="Patient Index", ylab="Probability of Best Treatment", col=colours[1], lwd=width)
...
sim_data3 <- simulator(numb_of_sims, numb_of_patients, one_run, balanced, NA)
balanced.props3 <- sim_data3[(numb_of_patients+6):(length(sim_data3))]
balanced.results3 <- sim_data3[1:(numb_of_patients+4)]
balanced.ys3 <- balanced.results3[1:(length(balanced.results3)-4)]
balanced.power3 <- balanced.results3[length(balanced.results3)-3]
balanced.ENS3 <- mean(balanced.ys3)
balanced.S103 <- balanced.results[length(balanced.results3)]
sprintf("power is %f", balanced.power)

plot(balanced.ys3 ~ x, type='l',xlim=c(0,numb_of_patients),ylim=c(0,1), main="Uniform Priors & 1000 Patients", sub=paste(numb_of_patients, "Patients"), xlab="Patient Index", ylab="Probability of Best Treatment", col=colours[1], lwd=width)
lines(thomper.ys3 ~ x, col=colours[2], lwd=width)
lines(greedy.ys3 ~ x, col=colours[4], lwd=width)
```
...
sim_data4 <- simulator(numb_of_sims, numb_of_patients, one_run, balanced, NA)
balanced.props4 <- sim_data4[(numb_of_patients+6):(length(sim_data4))]
balanced.results4 <- sim_data4[1:(numb_of_patients+4)]
balanced.ys4 <- balanced.results4[1:(length(balanced.results4)-4)]
balanced.power4 <- balanced.results4[length(balanced.results4)-3]
balanced.ENS4 <- mean(balanced.ys4)
balanced.S104 <- balanced.results4[length(balanced.results4)]
sprintf("power is %f", balanced.power4)

plot(balanced.ys4 ~ x, type='l',xlim=c(0,numb_of_patients),ylim=c(0,1), main="Unequal Priors & 1000 Patients", sub=paste(numb_of_patients, "Patients"), xlab="Patient Index", ylab="Probability of Best Treatment", col=colours[1], lwd=width)
