...
one_run <- function(n, chooser, chooser_params, alpha, minimum_interesting_delta) {
...
plot(x1, y1, type="l", col="red", main="Plot of Bayesian Priors", ylab="Density", xlab="Proportion")
