...
png("C:\\Users\\nanki\\Downloads\\greedy, EBM, Thomper; proportions.png")
par(mfrow = c(2, 2))
hist(greedy.props1, xlim=c(0,1), ylim=c(0,8000), col=rgb(1,0,0,0.4), main="Uniform Priors & 100 patients", xlab="Proportion getting best treatment")
hist(thomper.props1, xlim=c(0,1), col=rgb(0,1,0,0.4), add=TRUE)
hist(ebm_100.props1, xlim=c(0,1), col=rgb(0,0,1,0.4), add=TRUE)
```
...
hist(greedy.props1, xlim=c(0,1), ylim=c(0,8000), col=rgb(1,0,0,0.4), main="Unequal Priors & 100 patients", xlab="Proportion getting best treatment")
hist(thomper.props1, xlim=c(0,1), col=rgb(0,1,0,0.4), add=TRUE)
hist(ebm_100.props1, xlim=c(0,1), col=rgb(0,0,1,0.4), add=TRUE)
```
...
hist(greedy.props3, xlim=c(0,1), ylim=c(0,8000), col=rgb(1,0,0,0.4), main="Uniform Priors & 1000 Patients", xlab="Proportion getting best treatment")
hist(thomper.props3, xlim=c(0,1), col=rgb(0,1,0,0.4), add=TRUE)
hist(ebm_100.props3, xlim=c(0,1), col=rgb(0,0,1,0.4), add=TRUE)
```
...
hist(greedy.props4, xlim=c(0,1), ylim=c(0,8000), col=rgb(1,0,0,0.4), main="Unequal Priors & 1000 Patients", xlab="Proportion getting best treatment")
hist(thomper.props4, xlim=c(0,1), col=rgb(0,1,0,0.4), add=TRUE)
hist(ebm_100.props4, xlim=c(0,1), col=rgb(0,0,1,0.4), add=TRUE)
dev.off()
```
