...
png("C:\\Users\\nanki\\Downloads\\greedy, EBM, Thomper; frontier.png")
...
var_roots_minimal = c("greedy","thomper","ebm_100")
...
plot(x,y,xlim=c(0,1),ylim=c(0.45,1),main="Expected Number of Successes vs Statistical Power",sub=paste0(numb_of_patients," Patients"),xlab="Power",ylab="ENS")
text(as.numeric(x)+0.01,as.numeric(y)+0.01,labels=labels,cex=1)
